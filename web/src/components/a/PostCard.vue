<template>
  <div class="post-card">
    <div class="post-info">
      <div class="post-title" @click="goSubject">
        {{post.title}}
        <span class="draft" v-if="post.public === 0">草稿</span>
      </div>
      <div class="post-subtitle">{{post.created_at | datrfmt('YYYY-MM-DD HH:mm:ss')}}</div>
      <div class="post-desc">{{post.description}}</div>
    </div>
    <button type="button" class="icon-button" @click="showPostSetting = !showPostSetting">
      <i class="icon">
        <svg
          t="1594175958278"
          class="icon"
    ...
    <div class="setting-popover" v-show="showPostSetting" @mouseleave="showPostSetting = false">
      <div class="setting-list">
        <span class="setting-list-item" v-if="post.public === 0">
          <i class="setting-list-item-icon">
            ...
            >
              <path
                d="M934.4 1024 96 1024c-51.2 0-93.44-42.24-93.44-93.44L2.56 93.44c0-51.2 42.24-93.44 93.44-93.44l464.64 0 61.44 0 30.72 0c16.64 0 30.72 14.08 30.72 30.72s-14.08 30.72-30.72 30.72l-30.72 0-61.44 0L128 61.44c-34.56 0-61.44 28.16-61.44 61.44l0 775.68c0 34.56 28.16 61.44 61.44 61.44l775.68 0c34.56 0 61.44-28.16 61.44-61.44L965.12 404.48l0-56.32 0-5.12c0-16.64 14.08-30.72 30.72-30.72 16.64 0 30.72 14.08 30.72 30.72l0 61.44 0 527.36C1026.56 983.04 985.6 1024 934.4 1024L934.4 1024zM427.52 613.12c-11.52 11.52-32 11.52-43.52 0s-11.52-32 0-43.52L940.8 8.96c11.52-11.52 32-11.52 43.52 0 11.52 11.52 11.52 32 0 43.52L427.52 613.12 427.52 613.12zM427.52 613.12"
                p-id="6887"
              />
            </svg>
          </i>
          <span class="setting-list-item-text">发布</span>
        </span>
        <span class="setting-list-item">
          <i class="setting-list-item-icon">
            ...
            >
              <path
                d="M1056.601038 1023.966721H97.468406a96.636437 96.636437 0 0 1-97.020423-98.044384V98.112862A96.636437 96.636437 0 0 1 97.468406 0.00448h194.488828a89.596696 89.596696 0 0 1 77.629138 43.198407l116.475704 168.633782a168.697779 168.697779 0 0 0 135.86699 70.397404h431.152102a96.636437 96.636437 0 0 1 97.020422 97.980387v545.387888A91.324632 91.324632 0 0 1 1056.601038 1023.966721zM113.339821 54.978453a57.917864 57.917864 0 0 0-56.189928 56.893902v799.970501a58.04586 58.04586 0 0 0 56.189928 56.957899h927.389802a58.237852 58.237852 0 0 0 56.381921-56.957899V395.061912a58.173855 58.173855 0 0 0-56.381921-56.829904h-416.624637a204.152472 204.152472 0 0 1-167.481824-78.909091L329.523849 80.577509a54.589987 54.589987 0 0 0-48.766202-26.559021z m942.557243 266.230182a23.679127 23.679127 0 0 1-24.95908-25.21507V220.156362a77.501142 77.501142 0 0 0-75.197227-75.773206H408.880923a25.599056 25.599056 0 0 1 0-50.622133h546.859834A127.99528 127.99528 0 0 1 1080.920141 220.156362v75.837203a23.743124 23.743124 0 0 1-25.023077 25.151073z"
                p-id="27723"
              />
            </svg>
          </i>
          <span class="setting-list-item-text">
            移动到
            <div class="setting-popover" v-show="showSubjectList">
              <div class="setting-list">
                <div class="setting-list-item">Hello world</div>
                <div class="setting-list-item">Go</div>
              </div>
            </div>
          </span>
        </span>
...
export default {
  ...
  methods: {
    goSubject() {
      this.$router.push(`/admin/subject/${this.subject.id}/post`);
    },
