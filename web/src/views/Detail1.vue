  ...
  <div class="detail fadeInUp">
    <el-skeleton style="width:100%" :loading="loading" animated :throttle="500">
      <template slot="template">
        ...
        <div
          style="display:flex;align-items:center;justify-item:space-between;margin-top:16px;height:16px;"
        >
          <el-skeleton-item
            variant="text"
      ...
      <template>
        ...
        <!-- <div id="post-content" class="post-content  markdown-body" v-html="post.html_content"></div> -->
