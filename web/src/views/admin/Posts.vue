          ...
          <section class="content-list">
            <ol class="post-list">
              ...
              <li class="post-list-item" v-for="post in posts" :key="post.id">
                ...
                >
                  <div class="status">
                    <span v-if="post.status === 1" class="status-draft">{{
                      $t("post.status.draft")
                    }}</span>
                    <span v-if="post.status === 2" class="status-published">{{
                      $t("post.status.published")
                    }}</span>
                    <span v-if="post.status === 3" class="status-deleted">{{
