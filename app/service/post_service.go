...
//func (p *PostServiceImpl) SelectOne(post *domain.Post) (*vo.VPosts, error) {
...
// SelectAllWeb 查询公开博客
//func (p *PostServiceImpl) SelectAllWeb(c *gin.Context, page *pager.Pager, filter *dto.ListPosts) error {
//	var posts []*domain.Post
...
//}
//
//func (p *PostServiceImpl) SelectAll(page *pager.Pager, filter *dto.ListPosts) error {
//	var posts []*domain.Post
//	var vPosts []*vo.VPosts
//	var order domain.Dict
//
...
//}
//
//func (p *PostServiceImpl) DeleteOne(c *gin.Context, id int) error {
...
//}
//
//func (p *PostServiceImpl) CreateOne(params *dto.AddPosts) (vPost *vo.VPosts, err error) {
//	post := &domain.Post{
//		Title:           params.Title,
...
//}
//
//func (p *PostServiceImpl) UpdateOne(params *dto.PutPosts) (vPosts *vo.VPosts, err error) {
//	// 查询post是否存在
//	var post *domain.Post
